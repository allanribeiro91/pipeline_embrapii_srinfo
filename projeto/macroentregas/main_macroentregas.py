...
scripts_macroentregas_path = os.path.abspath(os.path.join(current_dir, 'scripts'))
sys.path.append(scripts_macroentregas_path)
from tratamento_dados import processar_dados

def main_macroentregas():
    ...
    processar_dados()
    print('main_macroentregas finalizado!!')
